...
from itsy.lutfir import LutFIR
from itsy.nco import NCO
...
class ModulatorFixture:
    def __init__(self, dut, signal):
        ...
        self.nco_addr_offset = 0x4000
        self.phase_addr_offset = 0x8000
...
async def modulator(dut):
    ...
    l = LutFIR.make_nyquist(16, 4, 8, 16, 32)
    ...
    await modulator_fixture.program_frequency(16384)
...
def plot_td_and_spectrum(ax_arr, signal, name, fs, nyquist_lines=None, rng=(-150, 0)):
