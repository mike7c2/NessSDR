...
import sip
import threading
import waterfall_epy_block_0 as epy_block_0  # embedded python block
...
class waterfall(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "waterfall")
        ...
        self.samp_rate = samp_rate = 400000000/512
        self.mode = mode = 0
        ...
        self._mode_range = qtgui.Range(0, 2, 1, 0, 200)
        ...
        self.epy_block_0 = epy_block_0.ExampleBlock(mode=mode, frequency=frequency, zone=((zone-12500000)/25000000))
    ...
    def set_zone(self, zone):
        self.zone = zone
        self.epy_block_0.zone = ((self.zone-12500000)/25000000)
